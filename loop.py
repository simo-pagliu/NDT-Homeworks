...
def main(delta, h_plenum):
    ...
    previous_T_map, _ = temperature_map(Coolant_Proprieties, Cladding_Proprieties, Helium_Proprieties, 
                            Fuel_Proprieties, ThermoHydraulics, Geometrical_Data, T_fuel_out, Burnup, He_percentage)
