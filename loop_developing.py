...
print("HM_molar_mass", HM_molar_mass)
HM_qualities = [Fuel_Proprieties.Qualities[i] for i in [0,1,3]]
print("HM_qualities", HM_qualities)
...
############################################################################################################
            # Calculate T_map
            T_map = temperature_map(Coolant_Proprieties, Cladding_Proprieties, Helium_Proprieties, 
            ...
            R_void = get_R_void(Fuel_Proprieties, R_columnar, R_equiaxied)
            ...
            = thermal_expansion(Fuel_Proprieties, Cladding_Proprieties, Geometrical_Data_Cold, T_map)
############################################################################################################
